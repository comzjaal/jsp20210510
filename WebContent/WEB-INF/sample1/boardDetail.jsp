			...
			<div class="col-8">
				...
				<form id="form1" action="${pageContext.request.contextPath }/sample1/modify" method="post">
					<div class="form-group">
						...
						<input readonly type="text" name="title" class="form-control" id="input1" value="${board.title }"/>
					</div>
					
					<div class="form-group">
						<label for="input2">작성자</label>
						<input readonly type="text" name="writer" class="form-control" id="input2" value="${board.writer }"/>
					</div>
